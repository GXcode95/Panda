...
ActiveRecord::Schema.define(version: 2022_02_09_135311) do
  ...
  create_table "courses", force: :cascade do |t|
    ...
    t.bigint "initiation_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["initiation_id"], name: "index_courses_on_initiation_id"
  ...
  create_table "initiations", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["theme_id"], name: "index_initiations_on_theme_id"
  end
  ...
  add_foreign_key "courses", "initiations"
  add_foreign_key "courses", "structures"
  add_foreign_key "initiations", "themes"
